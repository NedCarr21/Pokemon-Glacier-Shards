  ...
  def self.generate
    ...
    for x in x_range[0]..x_range[1]
      for y in y_range[0]..y_range[1]
        ...
        elsif hasCave && !terrain_tag.can_surf && $game_map.passable?($game_map.map_id, x, y, $game_player)
          phenomenon_tiles.push([x, y, :PhenomenonCave])
        elsif hasBird && terrain_tag.id == :BirdBridge && $game_map.passable?($game_map.map_id, x, y, $game_player)
