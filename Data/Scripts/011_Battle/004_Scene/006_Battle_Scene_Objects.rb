...
class Battle::Scene::PokemonDataBox < Sprite
  ...
  def initializeDataBoxGraphic(sideSize)
    ...
    when 2
      ...
      @spriteY += [-24, -40, 40, 24][@battler.index]
    when 3
...
#    pbSetSmallFont(@hpNumbers.bitmap)
  ...
  def x=(value)
    ...
    @hpNumbers.x = value + @spriteBaseX + 124
  end
  ...
  def draw_name
    ...
    pbDrawTextPositions(self.bitmap, [[@battler.name, @spriteBaseX + 98 - nameOffset, 40, :left,
  ...
  def draw_gender
    ...
    pbDrawTextPositions(self.bitmap, [[gender_text, @spriteBaseX + 216, 40, :left, base_color, shadow_color]])
  end
  ...
  def refresh_hp
    ...
    # Show HP numbers
    if @show_hp_numbers
      pbDrawNumber(self.hp, @hpNumbers.bitmap, 46, 2, :right)
      pbDrawNumber(-1, @hpNumbers.bitmap, 46, 2)   # / char
      pbDrawNumber(@battler.totalhp, @hpNumbers.bitmap, 62, 2)
    end
    # Resize HP bar
    w = 0
    if self.hp > 0
